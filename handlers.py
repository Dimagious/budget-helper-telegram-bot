...
async def set_expense_amount(update: Update, context: CallbackContext) -> int:
    ...
    try:
        ...
        row_to_update = gs_helper.get_categories(constants.EXPENSE_SHEET_NAME, constants.RANGE_FOR_EXPENSE_CATEGORIES).get(category)
...
async def set_income_amount(update: Update, context: CallbackContext) -> int:
    ...
    try:
        ...
        row_to_update = gs_helper.get_categories(constants.INCOME_SHEET_NAME, constants.RANGE_FOR_INCOME_CATEGORIES).get(category)
        col_to_update = get_current_month_column()
